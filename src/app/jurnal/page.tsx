    ...
    <main className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-grow container mx-auto px-4 py-10 max-w-4xl">
        ...
        {loading ? (
          ...
          <div className="text-center text-gray-500 mt-20 bg-white p-10 rounded-xl shadow-sm">Belum ada kegiatan yang dicatat oleh tim KKN.</div>
        ) : (
          <div className="space-y-6">
            {daftarJurnal.map((jurnal) => (
              <div key={jurnal.id} className="bg-white p-6 rounded-xl shadow-md border-l-4 border-green-600 hover:shadow-lg transition duration-300">
                ...
                {jurnal.gambar && (
                  <img src={jurnal.gambar} alt={jurnal.judul} referrerPolicy="no-referrer" className="w-full max-h-96 object-cover rounded-lg mb-4 shadow-sm" />
                )}
